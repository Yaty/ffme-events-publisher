...
export default class Crawler {
  ...
  private async login(): Promise<void> {
    ...
    await this.page.click('.bouton_right');
    await this.page.waitForSelector('#ID_PROFIL');
  }

  private async selectProfile(): Promise<void> {
    await this.page.click('#ID_PROFIL > option:nth-child(2)');
    await this.page.click('.bouton_right');
    await this.page.waitForSelector('#menu31');
  }

  private async selectLigueManagement(): Promise<void> {
    await this.page.click('#menu31 > p:nth-child(1) > a:nth-child(5)');
    await this.page.waitForSelector('#cadreTableauOngletGU');
  }
